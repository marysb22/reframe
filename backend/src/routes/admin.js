...
const USER_SELECT = `
  SELECT
    ...
    st.gender, st.date_of_birth, st.marital_status, st.address, st.certifications,
...
// Hour type definitions (create/rename/deactivate/set-primary) are managed
// by Master Trainer and Trainer (ToT), not Admin -- see
