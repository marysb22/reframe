...
const translations = {
  en: {
    ...
    event1_title: "The Invisible Weight: Foundations of Eating Disorder Care for Dietitians",
    event1_date: "Wednesday, July 30, 2025 | 8:00 PM – 9:00 PM Beirut Time",
...
contact_address_title: "Address",
  ...
  // Comprehensive translations for Reframe MHS website
// About Page + Team Members (EN / AR)


    // ===== Page Meta =====
    page_title_about: "About Us - Reframe MHS",
    page_description_about:
      "Learn about Reframe MHS mission, vision, and our team of mental health professionals in the Middle East.",

    // ===== Hero Section =====
    about_hero_title: "About Reframe MHS",
    about_hero_subtitle:
      "We envision a future where mental health is the foundation of every human system, and where challenges and failures are embraced as opportunities for growth and transformation.",

    // ===== Mission Section =====
    mission_title: "Our Mission",
    mission_description:
      "We provide evidence-based and culturally adapted mental health approaches that empower individuals, groups, and organizations to navigate challenges and reach their highest potential.",

    // ===== Core Values =====
    values_title: "Our Core Values",
    values_subtitle:
      "Guiding principles that shape our approach to mental health services",
    value_compassion_title: "Compassion",
    value_compassion_desc:
      "We approach every individual with empathy, understanding, and genuine care for their wellbeing.",
    value_cultural_title: "Cultural Sensitivity",
    value_cultural_desc:
      "Our services are tailored to respect and honor the diverse cultural contexts of the Middle East.",
    value_innovation_title: "Innovation",
    value_innovation_desc:
      "We continuously evolve our practices to incorporate the latest evidence-based approaches.",
    value_collaboration_title: "Collaboration",
    value_collaboration_desc:
      "We work together with individuals, families, and communities to achieve lasting positive change.",
    ...
    consultations_group_1: "Stress management sessions (post-crisis, burnout, or high workload).",
    consultations_group_2: "Peer support groups (safe space for staff to share experiences).",
    consultations_group_3: "Resilience circles using art, storytelling, and movement.",
    consultations_group_4: "Team-building with therapeutic methods (clay work, role play, metaphor-based activities).",
    ...
    consultations_workshops_4: "Trauma-informed care for hustle environment.",
    ...
    consultations_org_1: "Psychosocial risk assessments (survey + focus groups).",
    consultations_org_2: "Monitoring and evaluation system for staff well-being.",
    consultations_org_3: "Monthly/quarterly management reports: risks, staff needs, recommendations.",
    ...
    consultations_special_3: "Palliative and transition support for staff leaving organizations.",
    consultations_special_4: "Emergency response packages for crises (war, disaster, sudden layoffs).",
...
hub_why_text: "Whether you're an individual, a small business, or a corporate client, our services go beyond offering space. We provide expert income tax, accounting, and bookkeeping services tailored to your unique requirements. Consider us an extension of your team, dedicated to supporting your success.",
...
hub_cta_btn: "Book Now",
 footer_brand: "Reframe MHS",
    ...
    footer_copyright: "©2025 Reframe Mental Health Services. All rights reserved.",
...
event2_title: "Eating Disorder Care Training",
    ...
    core_values_resilience_desc:
      "We help individuals and organizations embrace challenges as opportunities for development and sustainable progress.",

    core_values_innovation_title: "Innovation Excellence",
    core_values_innovation_desc:
      "We are committed to innovative practices that enhance mental health services and improve impact.",

    core_values_integrity_title: "Integrity and Authenticity",
    core_values_integrity_desc:
      "We act with honesty, transparency, and respect in all our endeavors, ensuring trust and authenticity in every interaction.",

    core_values_evidence_title: "Evidence-Based Practice",
    core_values_evidence_desc:
      "We provide services and programs grounded in evidence-based approaches to ensure effectiveness and sustainability.",

    core_values_inclusivity_title: "Inclusivity and Diversity",
    core_values_inclusivity_desc:
...
// ===== ABOUT SECTION (Technical Consultations) =====
...
hero_subtitle: "Professional mental health services and training programs designed for the unique cultural context of the Middle East.",
  ...
  ar: {
    // ===== قسم الهيرو =====
hero_title: "إطلاق الإمكانات الإنسانية والمرونة",
hero_subtitle: "خدمات وبرامج تدريب مهنية مصممة خصيصًا للسياق الثقافي الفريد في الشرق الأوسط.",

    // ===== قسم نبذة عنا (الاستشارات التقنية) =====
...
changing_words_5: "ورش العمل والتدريب",
    ...
    // ===== صفحة الاستشارات التقنية =====
page_title_consultations: "الاستشارات التقنية - ريفريم",
page_description_consultations: "استشارات مهنية للمؤسسات تركز على رفاهية الموظفين، تعزيز المرونة، وضمان النجاح المؤسسي.",

// القسم التعريفي
consultations_hero_title: "الاستشارات التقنية",
consultations_hero_subtitle: "نقدم الموارد، والصحة العلائقية، والانسجام النظامي لدعم فرق عملكم.",
...
consultations_group_1: "جلسات لإدارة الضغوط (بعد الأزمات أو حالات الإرهاق أو ضغط العمل).",
consultations_group_2: "مجموعات دعم نظيري (مساحة آمنة لمشاركة الخبرات).",
consultations_group_3: "دوائر المرونة باستخدام الفن والسرد والحركة.",
consultations_group_4: "أنشطة بناء فرق بأساليب علاجية.",

consultations_workshops_title: "ورش العمل والتدريب",
consultations_workshops_1: "إدارة الضغوط والوقاية من الاحتراق النفسي.",
consultations_workshops_2: "مهارات المرونة في البيئات عالية الضغط.",
consultations_workshops_3: "تنظيم العواطف واستراتيجيات التكيف.",
consultations_workshops_4: "الرعاية المستنيرة بالصدمات في بيئات العمل المكثفة.",
consultations_workshops_5: "التوعية بالصحة النفسية وتقليل الوصمة.",

consultations_org_title: "الخدمات المؤسسية",
consultations_org_1: "تقييمات المخاطر النفسية والاجتماعية.",
consultations_org_2: "أنظمة متابعة وتقييم لرفاهية الموظفين.",
consultations_org_3: "تقارير إدارية عن المخاطر واحتياجات الموظفين والتوصيات.",
consultations_org_4: "وساطة أثناء النزاعات في بيئة العمل.",

consultations_special_title: "التدخلات المتخصصة",
consultations_special_1: "أيام رعاية الموظفين الموضوعية (فن، موسيقى، تأمل).",
consultations_special_2: "دعم للمديرين حول القيادة الواعية بالصحة النفسية.",
consultations_special_3: "دعم انتقالي للموظفين المغادرين للمؤسسات.",
consultations_special_4: "حزم استجابة طارئة للأزمات.",

    // ===== قسم الفريق =====
team_ali_name: "علي العطار",
team_ali_role: "المؤسس والمدير، رئيس مختبر الصحة النفسية",
team_ali_bio:
  "أخصائي نفسي إكلينيكي ومعالج نفسي متميز، ملتزم بعمق بتحسين خدمات الصحة النفسية في العالم العربي. نجح علي في التعاون مع شركات ومنظمات ووكالات أممية لتصميم وتنفيذ مبادرات دعم نفسي واجتماعي مؤثرة في الشرق الأوسط وأفريقيا. في قيادته لمختبر الصحة النفسية، يُعرف علي بنهجه الابتكاري في تطوير البرامج وإدارته الفعالة للفرق، مما يضمن تقديم تدخلات مدعومة علميًا وملائمة ثقافيًا ذات أثر إيجابي عميق على الأفراد والمجتمعات.",

team_zeina_name: "زينة بلوط",
team_zeina_role: "الشريكة المؤسسة ومنسقة البرامج",
team_zeina_bio:
  "تلعب زينة دورًا محوريًا في الإشراف على البرامج والخدمات المختلفة التي تقدمها المؤسسة. بخبرة تمتد لعشر سنوات في إدارة البرامج، تمتلك معرفة واسعة وخبرة عملية في تطوير وتنفيذ وتقييم البرامج لضمان جودة الخدمات المقدمة.",

team_mary_name: "ماري-أديل سالم",
team_mary_role: "المستشارة التقنية",
team_mary_bio:
  "ماري-أديل متخصصة في الدعم النفسي والاجتماعي منذ عام 2006، كرّست مسيرتها المهنية لتطبيق منهج قائم على الموارد في مجال الدعم النفسي والاجتماعي، متعاونة مع منظمات غير حكومية ووكالات أممية في بيئات ثقافية متعددة. عملت في آسيا وأفريقيا والشرق الأوسط وأمريكا اللاتينية وأوروبا.",

team_bertha_name: "بيرثا ميسّيادي",
team_bertha_role: "مديرة ضبط الجودة",
team_bertha_bio:
  "بيرثا ميسّيادي خبيرة متمرسة في ضمان الجودة وإدارة البرامج. تعاونت عن قرب مع منظمات دولية وهيئات أممية في آسيا وأمريكا الوسطى والولايات المتحدة وأوروبا وأفريقيا والشرق الأوسط. تمتلك خبرة قوية في تطوير البرامج، وصياغة نظريات التغيير، ووضع سياسات واستراتيجيات للدعم النفسي والاجتماعي. كما تمتلك خبرة في إنشاء أنظمة رعاية للموظفين وتعزيز قدرات الفرق من خلال التدريب والإشراف.",
    ...
    core_values_empathy_desc:
      "نحن ملتزمون بتعزيز الفهم والتعاطف في جميع تعاملاتنا، وخلق بيئة داعمة ومغذية لكل من نتعامل معهم. يضمن التزامنا أن يشعر الجميع بالتقدير والرعاية، مما يعزز العلاقات الصحية والنمو.",

    core_values_resilience_title: "المرونة والنمو",
    core_values_resilience_desc:
      "نساعد الأفراد والمنظمات على احتضان التحديات كفرص للتطور والتقدم المستدام.",

    core_values_innovation_title: "الابتكار والتميز",
    core_values_innovation_desc:
      "نحن ملتزمون بالممارسات المبتكرة التي تعزز خدمات الصحة النفسية وتزيد من أثرها.",

    core_values_integrity_title: "النزاهة والأصالة",
    core_values_integrity_desc:
      "نتصرف بصدق وشفافية واحترام في جميع مساعينا، مما يضمن الثقة والأصالة في كل تفاعل.",

    core_values_evidence_title: "الممارسة المبنية على الأدلة",
    core_values_evidence_desc:
      "نقدم خدمات وبرامج تستند إلى أساليب قائمة على الأدلة لضمان الفعالية والاستدامة.",

    core_values_inclusivity_title: "الشمولية والتنوع",
    core_values_inclusivity_desc:
      "نحن نحتضن التنوع وننشئ بيئة شاملة تحترم وتقدّر تفرد الأفراد وتجاربنا الإنسانية المشتركة. من خلال تعزيز الشمولية، نُنمّي الفهم والتواصل بين الجميع، مما يعزز التجربة المجتمعية ككل.",
...
timeline_title: "الجدول الزمني لقصتنا",
    ...
    timeline_2022_circle: "2022",
    timeline_2022_label: "ظهور الرؤية",
    timeline_2022_text: "في الربع الأخير من عام 2022، ظهرت رؤية مشتركة بين مجموعة من المعالجين ذوي الخبرة من الشرق الأوسط وخارجه. اتحدنا بدافع عميق لنخلق موارد للصحة النفسية تتميز بالصرامة المهنية والجذور الثقافية العربية الحقيقية — تعالج الواقع الفعلي لمجتمعاتنا.",

    timeline_2023_circle: "2023",
    timeline_2023_label: "بناء الأسس",
    timeline_2023_text: "في عام 2023، ركزنا على بناء أسس قوية. استمعنا بعمق، وتعلمنا بكثافة، وسعينا لفهم الاحتياجات الفريدة والمعقدة لمن نخدمهم. كان التزامنا واضحًا: المضي قدمًا بالصدق والرعاية والتفاني المطلق لدعم من هم في أمس الحاجة.",

    timeline_2024_circle: "2024",
    timeline_2024_label: "محطات رئيسية",
    timeline_2024_text: "عام 2024 كان بداية ظهور ثمار جهودنا. أطلقنا أول تدريب مهني وتعاون دولي، وبدأنا مشروعًا بحثيًا حول نوبات الهلع، وتعاوننا مع منظمات غير حكومية وشركات عبر الشرق الأوسط. معًا، عززنا بيئات يكون فيها رفاهية الموظفين أولوية.",

    timeline_2025_circle: "2025",
    timeline_2025_label: "توسع الأثر",
    timeline_2025_text: "مع دخول عام 2025، عززنا التزامنا بالتأثير طويل المدى. طورنا برامج تدريبية وتدخلات شاملة مدفوعة بنفس الإلحاح والتعاطف الذي وجهنا منذ البداية. هدفنا لم يكن مجرد إضافة خدمات — بل إعادة تشكيل جوهر دعم الصحة النفسية في منطقتنا.",

    timeline_beyond_circle: "ما بعد",
    timeline_beyond_label: "معًا نحو الأمام",
    timeline_beyond_text: "في ريفرام، نسير جنبًا إلى جنب مع المهنيين والشركات والباحثين — لنقدم حلولًا مخصصة تدعم، وتمكن، وتلهم. معًا، نواصل هذه الرحلة يدًا بيد، معيدين صياغة الصحة النفسية لمستقبل أكثر صحة ومرونة.",
    ...
    lab_desc: "انضم إلى مبادراتنا البحثية المبتكرة لتطوير رعاية الصحة النفسية في منطقة الشرق الأوسط.",
    lab_collaboration_question: "هل ترغب في التعاون معنا؟",
    ...
    // ===== MILESTONES =====
    milestones_title: "محطاتنا حتى الآن",
    milestones_subtitle: "نحتفل برحلتنا وأثرنا في مجال الصحة النفسية",
    milestone1_title: "20+ مؤسسة",
    milestone1_desc: "شركات، منظمات غير حكومية، ومؤسسات صحية",
    milestone2_title: "2+ مشاريع",
    milestone2_desc: "دراسات نشطة وتطوير أدوات تقييم",
    milestone3_title: "2+ مبادرات",
    milestone3_desc: "ابتكارات في الوعي بالصحة النفسية",

    // ===== PARTNERS =====
    partners_title: "شركاؤنا وتعاوناتنا",
    partners_subtitle: "نبني مجتمعات أقوى من خلال شراكات استراتيجية",


    footer_brand: "ريفريم MHS",
    footer_description: "نُطلق الإمكانات والمرونة الكامنة داخل كل فرد ومجموعة في جميع أنحاء الشرق الأوسط.",
    footer_quick_links: "روابط سريعة",
    nav_about: "معلومات عنا",
    nav_hub_reframe: "مركز ريفريم",
    nav_training: "التدريب",
    nav_consultations: "الاستشارات",
    footer_services: "الخدمات",
    footer_training: "برامج تدريبية",
    ...
    footer_copyright: "©2025 خدمات ريفريم للصحة النفسية. جميع الحقوق محفوظة.",
...
hub_why_text: "سواء كنت فردًا، شركة صغيرة، أو مؤسسة كبرى، خدماتنا تتجاوز مجرد توفير المساحة. نحن نقدم خدمات ضريبية ومحاسبية ومالية مصممة خصيصًا لتلبية متطلباتك الفريدة. اعتبرنا امتدادًا لفريقك، مكرسين لدعم نجاحك.",
...
contact_address_title: "العنوان",
    ...
    page_description_about:
      "تعرّف على مهمة ريفريم ورؤيتها وفريقها من الأخصائيين النفسيين في الشرق الأوسط.",

    // ===== Hero Section =====
    about_hero_title: "عن ريفريم",
    about_hero_subtitle:
      "نحن نتصور مستقبلًا تكون فيه الصحة النفسية أساس كل نظام إنساني، حيث يتم اعتبار التحديات والإخفاقات فرصًا للنمو والتحول.",

    // ===== Mission Section =====
    mission_title: "مهمتنا",
    mission_description:
      "نقدم أساليب صحة نفسية قائمة على الأدلة وملائمة ثقافيًا لتمكين الأفراد والمجموعات والمؤسسات من مواجهة التحديات وتحقيق أعلى إمكاناتهم.",
    ...
    value_compassion_desc:
      "نتعامل مع كل فرد بتعاطف وفهم ورعاية حقيقية لرفاهيته.",
    value_cultural_title: "الحس الثقافي",
    value_cultural_desc:
      "خدماتنا مصممة لاحترام وتقدير السياقات الثقافية المتنوعة في الشرق الأوسط.",
    value_innovation_title: "الابتكار",
    value_innovation_desc:
      "نطور ممارساتنا باستمرار لدمج أحدث الأساليب المبنية على الأدلة.",
    value_collaboration_title: "التعاون",
    value_collaboration_desc:
      "نعمل مع الأفراد والأسر والمجتمعات لتحقيق تغيير إيجابي دائم.",
...
milestones_title: "محطاتنا حتى الآن",
milestones_subtitle: "نحتفل برحلتنا وأثرنا في مجال الصحة النفسية",
milestone1_title: "5+ مؤسسات",
milestone1_desc: "شركات، منظمات غير حكومية، ومؤسسات صحية",
milestone2_title: "2+ مشاريع",
milestone2_desc: "دراسات نشطة وتطوير أدوات تقييم",
milestone3_title: "500+ مهني",
